...
const CreateCommunityModal:React.FC<CreateCommunityModalProps> = ({ open, handleClose }) => {
    ...
    const handleCreateCommunity = async () => {
        ...
        if (format.test(communityName) || communityName.length < 3) {
            setError('Community names must be between 3-21 characters, and con only contain letters, numbers, or underscores.');
            return; 
        };
        setLoading(true);
            ...
            <ModalContent>
              ...
              <Box pl={3} pr={3}>
                ...
                <ModalBody display="flex" flexDirection="column" padding="10px 0px" >
                    ...
                    <Text fontSize="pt" color="red" pt={1}>{error}</Text>
                    <Box mt={4} mb={4}>
                        ...
                        <Stack spacing={2}>
                            ...
                            <Checkbox name="restricted" isChecked={communityType === 'restricted'} onChange={onCommunityTypeChange}>
                                <Flex align="center">
                                    ...
                                    <Text fontSize="8pt" color="gray.500" pt={1}>Anyone can view this community, but only approvated users can post.</Text>
                                </Flex>
